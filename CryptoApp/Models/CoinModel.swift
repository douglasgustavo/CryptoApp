...
/*
 ...
 => page: Int = 1 -> Página
 => sparkline: Bool = true -> Histórico dos últimos 7 dias
 => price_change_percentage: String = 1h -> Porcentagem de mudança da moeda no tempo definido
...
class CoinModel: Identifiable, Codable {
    ...
    /// Função que atualiza o preço da moeda
    ...
    /// Variável calculada que contém o preço atual da moeda X quantidade de moedas do usuário
    var currentHoldingsValue: Double {
        return (currentHoldings ?? 0) * currentPrice
    }
    
    /// Variável calculada que contém o rank da moeda convertido para Int
    var rank: Int {
